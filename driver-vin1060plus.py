...
#                Unfortunately, currently declaration "pen: BTN_TOOL_PEN" have strange behavior. It add 
#                additional mouse button click&hold (BTN_LEFT=1) on xorg level when a stylus go into tablet 
#                radius. You will feel it as annoying behavior. 
#                So, if you will work with this device as mouse or pointer, comment out "pen: BTN_TOOL_PEN" 
#                declaration in config file. Gimp and Krita will work, however without pressure detection. 
#                Looks like it is not our driver but xorg behavior.
# ##########################################################################################################
